CREATE TABLE CaKoi (
    ...
    GioiTinh NVARCHAR(10),                    -- Gi?i tính c?a cá koi
    TinhCach NVARCHAR(255),                   -- Tính cách c?a cá koi
    LuongThucAnNgay DECIMAL(5, 2),            -- Lu?ng th?c an m?i ngày (gram)
    TiLeKiemTra DECIMAL(5, 2),                -- T? l? ki?m tra s?c kh?e (%)
...
CREATE TABLE SanPham (
    ...
    TinhCach NVARCHAR(50),		      -- Tính Cách
    LuongThucAnNgay DECIMAL(5,2),             -- L??ng Th?c ?n Ngày
    TiLeKiemTra DECIMAL(5,2),                 -- T? L? Ki?m Tra
